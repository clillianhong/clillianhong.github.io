...
const OceanTestPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const draw = (time: number) => {
      ...
      // Draw fish swimming along the surface
      ...
      // Body (drawn centered around origin)
  ...
  return (
    <>
      ...
      >
        {showControls ? '✕' : <img src="/pixel_wave_transparent.png" alt="controls" style={{ width: '20px', height: '20px', imageRendering: 'pixelated' }} />}
      </button>
      {showControls && <div
        style={{
          position: 'fixed',
      ...
      >
        <div style={{ color: '#9ACBD0', fontSize: '0.85rem', fontWeight: 700, marginBottom: '0.75rem' }}>
          Ocean Controls
        </div>
